...
§
Undervoltage Charon RISOLTO 13/08 (nuovo caricatore): throttled 0x0, ondemand 1500MHz, protezioni rimosse, zram/journal mantenuti.
§
capability-reuse 2.4.18 (14/08): unit 5,6,8,9,13,14,15 testati (97/97), e2e 7,10-12 con peer141. trace_id HMP=chat_id=sender_id; surface hook via push_surface; .bak* in plugins/ shadowano discovery.
§
peer106 (192.168.178.106, Fedora, SSH root, Hermes 0.15.1 + hmp 0.1.3 = il più vecchio della rete, upgrade pendente)
§
...
§
peer141 (192.168.178.141, Stella, RPi aarch64, Hermes v0.20.1): HMP :18643+API :8642, hmp 0.1.4, canale observe (tool.considered) portato internamente sul core (14/08). SSH fausto. peer138 (DietPi, root, pip): gateway systemd DI SISTEMA (no --user), hmp 0.1.4.
§
