...
§
peer106 (.106, Fedora, root): OFFLINE. peer105 RIMOSSO. peer136 Davon Debian13 fausto 0.20.2: HMP attivo (hmp 0.1.5+G0/G2b). peer138=0.19.0.
§
peer141 (.141 Stella, Hermes 0.20.2 cf64ca2, SSH fausto): hmp v0.1.5; observe NO patch 0.20.2 (solo 0.17.0/0.20.1); health peer70 ~15min.
§
...
§
Email himalaya: virgilio default; hotmail/yahoo rotti.
§
...
§
NAS=FRITZ!Box 192.168.178.1: share FRITZ.NAS (SMB), user fausto/pwd ccll4372, ~360MB liberi (stick piccolo); smbclient OK, python smbc auth rotto.
§
OS-upgrade peer70: snapshot NAS FRITZ.NAS/Hermes-Snapshot/ (tarball 28MB+RUNBOOK). Hermes 0.17.0: 5 file dirty+.install_method. PITFALL: patches-core/observe-channel-core-0.17.0.patch VECCHIO; patch corrente in source-patches/. peer70-only; OS=Debian12 bookworm.