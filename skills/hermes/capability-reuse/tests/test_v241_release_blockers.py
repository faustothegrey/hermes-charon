...
class V241ReleaseBlockerTests(unittest.TestCase):
    ...
    def _write_minimal_archive(self, archive_path, version="2.4.1"):
        files = {
            ...
            "capability-reuse/evidence/unit-test-report-v%s.json" % version: json.dumps({"passed": 1, "failed": 0}),
            "capability-reuse/evidence/conformance-report-v%s.json" % version: json.dumps({"evidence_scope": "local-controller", "passed": 15, "failed": 0}),
        }
        checks = []
